...
public class TestStreamAPI3 {
	...
	@Test
	public void test5(){
		Map<Status, List<Employee1>> map = emps.stream()
	...
	@Test
	public void test6(){
		Map<Status, Map<String, List<Employee1>>> map = emps.stream()
